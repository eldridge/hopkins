package Hopkins::State::Schema::ResultSet::Work;

=head1 NAME

Hopkins::State::Schema::ResultSet::Work - ResultSet class for Work

=head1 DESCRIPTION

this class houses ResultSet methods for the Work

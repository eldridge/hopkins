...
qw/
	...
	HOPKINS_QUEUE_STATUS_FROZEN
	HOPKINS_QUEUE_STATUS_SHUTDOWN
/;

use constant HOPKINS_ENQUEUE_OK					=> 1;
use constant HOPKINS_ENQUEUE_TASK_NOT_FOUND		=> 2;
use constant HOPKINS_ENQUEUE_QUEUE_FROZEN		=> 3;
use constant HOPKINS_ENQUEUE_QUEUE_UNAVAILABLE	=> 4;
...
use constant HOPKINS_QUEUE_STATUS_FROZEN		=> 3;
use constant HOPKINS_QUEUE_STATUS_SHUTDOWN		=> 4;
